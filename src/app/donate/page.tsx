...
// Dynamic import of the main donation page component
const DonationPage = dynamic(
  () => import("@/components/pages/donation/DonationPage"),
  { ssr: false }
);
...
export const metadata: Metadata = {
  title: "Donate | Media Challenge Initiative",
  description:
    "Support the next generation of journalists and content creators",
  ...
  openGraph: {
    ...
    description:
      "Support the next generation of journalists and content creators",
    images: ["/assets/images/hero/hero-1.jpg"]
  }
};
