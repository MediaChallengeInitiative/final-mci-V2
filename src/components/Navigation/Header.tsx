...
import { getNavItems, socialLinks } from "../../../data/navigation-data";
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden sm:flex flex-1 -mt-3 justify-center items-center space-x-1">
              {navItems.map((item) => (
                ...
                >
                  <Link
                    href={item.path}
                    className={`group flex items-center text-[15px] font-medium px-4 pt-1 rounded-lg transition-all duration-300 ease-in-out
                              ${
                                pathname === item.path
            ...
            <div className="hidden sm:flex -mt-3 items-center space-x-6">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="block mt-3 px-6 py-2.5 rounded-xl font-medium text-sm text-gray-900 bg-[#f6931d] border border-transparent transition-all duration-300"
              >
                Donate Now
              </motion.button>
            </div>
            ...
            <div className="sm:hidden flex items-center space-x-3">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 rounded-xl font-medium text-sm text-gray-900 bg-[#f6931d] border border-transparent transition-all duration-300"
              >
                Donate
              </motion.button>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.2 }}
            className="fixed inset-0 z-50 sm:hidden bg-gray-900/30 backdrop-blur-sm"
          >
            <motion.div
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              ...
              className="absolute right-0 top-0 bottom-0 w-full max-w-sm bg-gradient-to-br from-slate-900 to-sky-900"
            >
              <div className="flex items-center justify-end p-4">
                <motion.button
                  whileTap={{ scale: 0.9 }}
                  onClick={() => setIsMenuOpen(false)}
                  className="p-2 rounded-lg text-white hover:bg-sky-500/20 transition-all duration-300"
                >
              ...
              <div className="grid grid-cols-3 gap-4 p-6 border-t border-sky-500/30 bg-sky-700/30">
                {socialLinks.map((social) => {
                  const Icon = social.icon;
                  return (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center p-3 rounded-lg bg-sky-500/20 text-white hover:bg-sky-500/30 transition-all duration-300"
                    >
                      <Icon className="w-5 h-5" />
                    </motion.a>
                  );
              ...
              <div className="px-6 pb-6 pt-2">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-3 rounded-xl font-medium text-sm text-gray-900 bg-[#f6931d] border border-transparent transition-all duration-300"
                >
                  Donate Now
                </motion.button>
              </div>
...
//               <div className="grid grid-cols-4 gap-4 p-6 border-t border-sky-500/30 bg-sky-700/30">
//                 {socialLinks.map(
//                   (social: {
//                     icon: any;
//                     label: React.Key | null | undefined;
