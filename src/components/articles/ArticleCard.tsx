  ...
  ({ article, theme, index }: ArticleCardProps) => {
    ...
    return (
      <Link
        ...
        className="group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col h-full transform hover:-translate-y-1"
      >
        <div className="relative aspect-[16/9] overflow-hidden">
          ...
          <div className="absolute top-4 right-4">
            <span className="inline-flex items-center rounded-full px-4 py-1 text-sm font-medium bg-white/90 text-gray-900 backdrop-blur-sm">
        ...
        <div className="flex-1 p-6">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4 line-clamp-2 group-hover:text-sky-500 transition-colors duration-300">
            {article.title}
          </h3>
...
//       () => urlFor(article.mainImage).quality(85).url(),
//       [article.mainImage]
//     );
...
//         router.prefetch(`/press/articles/${article.slug}`);
