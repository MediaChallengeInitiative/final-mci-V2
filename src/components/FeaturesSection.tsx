...
import { FeatureCardProps } from "@/interface/features";
...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 -mr-20 -mt-20 opacity-5 transition-all duration-700 group-hover:scale-150 group-hover:opacity-10 group-hover:rotate-12">
        <div className="w-64 h-64">
          <Icon size={256} className="w-full h-full text-sky-400" />
        </div>
      </div>

      <div className="relative mb-6">
        <div className="w-16 h-16 transform transition-all duration-500 group-hover:scale-110 group-hover:-rotate-3">
          <Icon
            size={64}
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-light text-gray-200 group-hover:text-sky-400 transition-colors duration-300">
          {title}
        </h3>

        <p className="text-gray-400 group-hover:text-gray-300 transition-all duration-300 text-sm leading-relaxed">
          {description}
        </p>
        ...
        {benefits.length > 0 && (
          <ul className="space-y-3 pt-4">
            {benefits.map((benefit, idx) => (
              <li
                key={idx}
                className="flex items-start space-x-3 group/item transition-all duration-300 hover:translate-x-1"
              >
                <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-sky-500 group-hover:bg-sky-400 transition-colors duration-300" />
                <span className="text-gray-400 group-hover/item:text-gray-200 transition-colors duration-300 text-sm">
                  {benefit}
                </span>
              </li>
            ))}
      ...
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-br from-sky-900/20 to-transparent rounded-tl-full opacity-0 group-hover:opacity-100 transition-all duration-500 -z-10" />
    </div>
  );
};
...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section className="py-32 relative overflow-hidden bg-gray-50">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#4b5563_1px,transparent_1px),linear-gradient(to_bottom,#4b5563_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,black,transparent)] opacity-[0.03]" />
