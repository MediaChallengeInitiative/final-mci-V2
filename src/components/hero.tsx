...
const Hero = () => {
  ...
  const calculateTextMetrics = useCallback(
    (
      ...
      measurer.style.whiteSpace = isMobileView ? "normal" : "nowrap";
      measurer.style.fontWeight = "bold";
      measurer.style.fontFamily = "inherit";
      document.body.appendChild(measurer);

      // Adjust base size for mobile
      const mobileBaseSize = isMobileView ? baseSize * 0.4 : baseSize;
      const fontSize = mobileBaseSize;

      // For mobile, we don't need to calculate letter/word spacing
      if (isMobileView) {
      ...
      // Desktop calculation logic remains the same
  ...
  return (
    <div className="relative w-full h-screen bg-black">
      ...
      <AnimatePresence mode="wait">
        {slides.map((slide, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent md:bg-gradient-to-r md:from-black/80 md:via-black/50 md:to-transparent" />
          </motion.div>
        ))}
      </AnimatePresence>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.p
                  ...
                  className="text-[#f6931d] text-2xl md:text-4xl font-light italic capitalize"
                >
                  ...
                  {slides[currentSlide].lines.map((line, lineIndex) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={cn(
                            "text-white font-bold origin-left",
                            isMobile
      ...
      {/* Navigation */}
      <div className="absolute bottom-20 right-4 md:bottom-8 md:right-8 z-30">
        <div className="flex items-center space-x-2 md:space-x-4">
          {slides.map((_, index) => (
            ...
            >
              <div
                className={cn(
                  "w-8 md:w-16 h-1 rounded-full transition-all duration-300",
      ...
      {/* Slide Counter */}
      <div className="absolute left-4 bottom-20 md:left-8 md:bottom-8 z-30">
        <div className="text-white font-mono flex items-center space-x-2 md:space-x-4">
